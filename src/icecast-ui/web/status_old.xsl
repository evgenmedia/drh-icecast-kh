...
<xsl:for-each select="source">
    <div class="info_block  center-block wow flipInX" data-wow-delay=".5s">
              ...
              <div class="col-md-4 col-xs-6 text-right">
               ...
               <a href="{@mount}.m3u"> <i class="file">m3u</i></a>
                    ...
                    <div class="row main_inf">
                        <div class="col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay=".7s">
                        ...
                        <div class="col-md-5 col-sm-6 wow fadeInRight" data-wow-delay=".7s">
        ...
        <div class="container">
            <div class="row wow fadeIn">
                ...
                <div class="col-md-5 text-right">
                    <div class="nav">
                        <ul class="list-inline">
                            <li>Остались вопросы? Пишите на support@dline-media.com</li>
